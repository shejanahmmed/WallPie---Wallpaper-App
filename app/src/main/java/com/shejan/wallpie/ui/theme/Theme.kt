package com.shejan.wallpie.ui.theme
...
fun WallPieTheme(
    ...
    if (!view.isInEditMode) {
        SideEffect {
            val window = (view.context as? Activity)?.window ?: (view.context as? android.content.ContextWrapper)?.baseContext?.let { it as? Activity }?.window
            if (window != null) {
